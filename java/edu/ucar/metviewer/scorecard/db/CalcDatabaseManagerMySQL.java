/**
 * CalcDatabaseManagerMySQL.java Copyright UCAR (c) 2017. University Corporation for Atmospheric Research (UCAR), National Center for Atmospheric Research
 ...
 */
public class CalcDatabaseManagerMySQL extends DatabaseManagerMySQL {

  public CalcDatabaseManagerMySQL(Scorecard scorecard) {
    super(scorecard);
    aggStatDataFilePath = scorecard.getWorkingFolders().getDataDir() + scorecard.getDataFile();
