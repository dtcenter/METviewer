...
public class TestMariaDbDatabaseManager extends edu.ucar.metviewer.db.mysql.MysqlDatabaseManager implements edu.ucar.metviewer.test.TestDBManager {
    public TestMariaDbDatabaseManager(edu.ucar.metviewer.db.DatabaseInfo databaseInfo) throws Exception {
        super(databaseInfo);
    }
