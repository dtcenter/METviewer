...
a.append($("<caption_offset />").text($("#caption_offset").val()));a.append($("<caption_align />").text($("#caption_align").val()));a.append($("<ci_alpha />").text($("#ci_alpha").val()));a.append($("<eqbound_low />").text($("#eqbound_low").val()));a.append($("<eqbound_high />").text($("#eqbound_high").val()));b=sortSeries();d=[];c=[];f=[];var g=[],h=[],k=[],n=[],m=[],q=[],t=[],u=[];for(e=0;e<b.length;e++)d.push('"'+b[e].plot_ci+'"'),"No"===b[e].hide?c.push("TRUE"):c.push("FALSE"),"No"===b[e].show_signif?
