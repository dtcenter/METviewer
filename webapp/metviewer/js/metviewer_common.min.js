...
d=$("<add_skill_line />");d.text($("#add_skill_line").prop("checked"));a.append(d);d=$("<add_noskill_line />");d.text($("#add_noskill_line").prop("checked"));a.append(d);d=$("<add_reference_line />");d.text($("#add_reference_line").prop("checked"));a.append(d);d=$("<agg_stat />");d.append($("<agg_pct />").text("true"));d.append($("<boot_repl />").text($("#boot_repl").val()));d.append($("<boot_random_seed />").text($("#boot_random_seed").val()));d.append($("<boot_ci />").text($("#boot_ci").val()));
...
initXML.find("plot").find("summary_curve").children();for(b=0;b<a.length;b++)$("#summary_curve option[value='"+a[b]+"']").prop("selected",!0);try{$("#summary_curve").multiselect("refresh")}catch(c){}}b=!0;initXML.find("plot").find("add_skill_line")&&(b=$(initXML.find("plot").find("add_skill_line")).text(),"true"===b?$("#add_skill_line").prop("checked",!0):$("#add_skill_line").prop("checked",!1));initXML.find("plot").find("add_noskill_line")&&(b=$(initXML.find("plot").find("add_noskill_line")).text(),
"true"===b?$("#add_noskill_line").prop("checked",!0):$("#add_noskill_line").prop("checked",!1));initXML.find("plot").find("add_reference_line")&&(b=$(initXML.find("plot").find("add_reference_line")).text(),"true"===b?$("#add_reference_line").prop("checked",!0):$("#add_reference_line").prop("checked",!1));loadXMLStatistics()}
