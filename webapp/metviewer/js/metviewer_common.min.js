...
a.append($("<caption_offset />").text($("#caption_offset").val()));a.append($("<caption_align />").text($("#caption_align").val()));a.append($("<ci_alpha />").text($("#ci_alpha").val()));b=sortSeries();d=[];c=[];f=[];var g=[],h=[],k=[],n=[],m=[],q=[],t=[],u=[];for(e=0;e<b.length;e++)d.push('"'+b[e].plot_ci+'"'),"No"===b[e].hide?c.push("TRUE"):c.push("FALSE"),"No"===b[e].show_signif?u.push("FALSE"):u.push("TRUE"),f.push('"'+b[e].color+'FF"'),g.push(b[e].pch),h.push('"'+b[e].type+'"'),k.push(b[e].lty),
n.push(b[e].lwd),m.push(b[e].con_series),q.push(b[e].order),t.push('"'+b[e].legend+'"');a.append($("<plot_ci />").text("c("+d.join()+")"));a.append($("<show_signif />").text("c("+u.join()+")"));a.append($("<plot_disp />").text("c("+c.join()+")"));a.append($("<colors />").text("c("+f.join()+")"));a.append($("<pch />").text("c("+g.join()+")"));a.append($("<type />").text("c("+h.join()+")"));a.append($("<lty />").text("c("+k.join()+")"));a.append($("<lwd />").text("c("+n.join()+")"));a.append($("<con_series />").text("c("+
m.join()+")"));a.append($("<order_series />").text("c("+q.join()+")"));a.append($("<plot_cmd />").text($("#plot_cmd").val()));a.append($("<legend />").text("c("+t.join()+")"));0==$("#y1_lim_min").val().trim().length||0==$("#y1_lim_max").val().trim().length?a.append($("<y1_lim />").text("c()")):a.append($("<y1_lim />").text("c("+$("#y1_lim_min").val()+","+$("#y1_lim_max").val()+")"));0==$("#x1_lim_min").val().trim().length||0==$("#x1_lim_max").val().trim().length?a.append($("<x1_lim />").text("c()")):
a.append($("<x1_lim />").text("c("+$("#x1_lim_min").val()+","+$("#x1_lim_max").val()+")"));a.append($("<y1_bufr />").text($("#y1_bufr").val()));0==$("#y2_lim_min").val().trim().length||0==$("#y2_lim_max").val().trim().length?a.append($("<y2_lim />").text("c()")):a.append($("<y2_lim />").text("c("+$("#y2_lim_min").val()+","+$("#y2_lim_max").val()+")"));return a}
...
$("#plot_type").val($(initXML.find("plot").find("plot_type")).text()),$("#plot_height").val($(initXML.find("plot").find("plot_height")).text()),$("#plot_width").val($(initXML.find("plot").find("plot_width")).text()),$("#plot_units").val($(initXML.find("plot").find("plot_units")).text()),$("#cex").val($(initXML.find("plot").find("cex")).text()),$("#plot_res").val($(initXML.find("plot").find("plot_res")).text()),e=$(initXML.find("plot").find("mar")).text().replace("c(","").replace(")","").split(","),
$("#mar_bottom").val(e[0]),$("#mar_left").val(e[1]),$("#mar_top").val(e[2]),$("#mar_right").val(e[3]),e=$(initXML.find("plot").find("mgp")).text().replace("c(","").replace(")","").split(","),$("#mgp_title").val(e[0]),$("#mgp_labels").val(e[1]),$("#mgp_line").val(e[2]),$("#title_align").val($(initXML.find("plot").find("title_align")).text()),$("#title_offset").val($(initXML.find("plot").find("title_offset")).text()),$("#title_size").val($(initXML.find("plot").find("title_size")).text()),$("#title_weight").val($(initXML.find("plot").find("title_weight")).text()),
...
$("#ytlab_size").val($(initXML.find("plot").find("ytlab_size")).text()),$("#ytlab_orient").val($(initXML.find("plot").find("ytlab_orient")).text()),e=$(initXML.find("plot").find("y1_lim")).text().replace("c(","").replace(")","").split(","),$("#y1_lim_min").val(e[0]),$("#y1_lim_max").val(e[1]),$("#y1_bufr").val($(initXML.find("plot").find("y1_bufr")).text()),e=$(initXML.find("plot").find("x1_lim")).text().replace("c(","").replace(")","").split(","),$("#x1_lim_min").val(e[0]),$("#x1_lim_max").val(e[1]),
