...
$("#calc_stat").val("sl1l2"):"TRUE"==$(initXML.find("plot").find("calc_stat").find("calc_sal1l2")).text()?$("#calc_stat").val("sal1l2"):"TRUE"==$(initXML.find("plot").find("calc_stat").find("calc_vl1l2")).text()&&$("#calc_stat").val("vl1l2");try{$("#calc_stat").multiselect("refresh")}catch(r){}}else if("stat"===b)$("input[name=statistics][value=calculations_statistics]").prop("checked",!0),$("#aggregation_statistics ").hide(),$("#none").show();else if(-1!==listStatModelRatio.indexOf(d[0])){$("input[name=statistics][value=aggregation_statistics]").prop("checked",
!0);$("#agg_stat").val("mode");try{$("#agg_stat").multiselect("refresh")}catch(r){}$("#aggregation_statistics ").show();$("#calculations_statistics ").hide()}else $("input[name=statistics][value=calculations_statistics]").prop("checked",!0),$("#aggregation_statistics ").hide(),$("#none").show();a=$(initXML.find("plot").find("tmpl").find("listDiffSeries1")).text();0===a.length&&(a="list()");b=$(initXML.find("plot").find("tmpl").find("listDiffSeries2")).text();0===b.length&&(b="list()");if("list()"!==
a)for(e=a.split("c("),a=1;a<e.length;a++)e[a]=e[a].replace(/\(/g,"").replace(/\)/g,"").replace(/"/g,""),seriesDiffY1.push(e[a]);if("list()"!==b)for(b=b.split("c("),a=1;a<b.length;a++)b[a]=b[a].replace(")","").replace(")","").replace('"',""),seriesDiffY2.push(b[a]);"Perf"===currentTab?updateSeriesPerf():"Taylor"===currentTab?(updateSeriesRhist(),a=$(initXML.find("plot").find("taylor_voc")).text().toLowerCase(),$("input[name=taylor_voc][value="+a+"]").prop("checked",!0),b=$(initXML.find("plot").find("taylor_show_gamma")).text().toLowerCase(),
$("input[name=taylor_show_gamma][value="+b+"]").prop("checked",!0),"true"===a?$("#is_show_gamma").buttonset("enable"):$("#is_show_gamma").buttonset("disable")):updateSeries()}
