...
(a=$(initXML.find("plot").find("add_reference_line")).text(),"true"===a?$("#add_reference_line").prop("checked",!0):$("#add_reference_line").prop("checked",!1));loadXMLStatistics();$("#event_equal").prop("checked","true"==$(initXML.find("plot").find("event_equal")).text()).trigger("change")}
