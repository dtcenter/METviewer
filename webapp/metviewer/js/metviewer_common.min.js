...
"TRUE"===$(initXML.find("plot").find("agg_stat").find("agg_pct")).text()?$("#agg_stat").val("pct"):"TRUE"===$(initXML.find("plot").find("agg_stat").find("agg_nbrcnt")).text()?$("#agg_stat").val("nbrcnt"):"TRUE"===$(initXML.find("plot").find("agg_stat").find("agg_ssvar")).text()?$("#agg_stat").val("ssvar"):"TRUE"===$(initXML.find("plot").find("agg_stat").find("agg_vl1l2")).text()?$("#agg_stat").val("vl1l2"):"mode"===selected_mode&&-1!==listStatModelRatio.indexOf(fcst_stat[0])&&$("#agg_stat").val("mode");
try{$("#agg_stat").multiselect("refresh")}catch(b){}$("#boot_repl").val($(initXML.find("plot").find("agg_stat").find("boot_repl")).text());var a=$(initXML.find("plot").find("agg_stat").find("boot_random_seed")).text();Number.isInteger(a)?$("#boot_random_seed").val(a):$("#boot_random_seed").val("");$("#boot_ci").val($(initXML.find("plot").find("agg_stat").find("boot_ci")).text());$("#cacheAggStat").prop("checked","TRUE"==$(initXML.find("plot").find("agg_stat").find("cache_agg_stat")).text())}else if(0<
initXML.find("plot").find("calc_stat").length){$("input[name=statistics][value=calculations_statistics]").prop("checked",!0);$("#calculations_statistics").show();"TRUE"==$(initXML.find("plot").find("calc_stat").find("calc_ctc")).text()?$("#calc_stat").val("ctc"):"TRUE"==$(initXML.find("plot").find("calc_stat").find("calc_sl1l2")).text()?$("#calc_stat").val("sl1l2"):"TRUE"==$(initXML.find("plot").find("calc_stat").find("calc_sal1l2")).text()?$("#calc_stat").val("sal1l2"):"TRUE"==$(initXML.find("plot").find("calc_stat").find("calc_vl1l2")).text()&&
$("#calc_stat").val("vl1l2");try{$("#calc_stat").multiselect("refresh")}catch(b){}}else if("stat"===selected_mode)$("input[name=statistics][value=calculations_statistics]").prop("checked",!0),$("#aggregation_statistics ").hide(),$("#none").show();else if(-1!==listStatModelRatio.indexOf(fcst_stat[0])){$("input[name=statistics][value=aggregation_statistics]").prop("checked",!0);$("#agg_stat").val("mode");try{$("#agg_stat").multiselect("refresh")}catch(b){}$("#aggregation_statistics ").show();$("#calculations_statistics ").hide()}else $("input[name=statistics][value=calculations_statistics]").prop("checked",
