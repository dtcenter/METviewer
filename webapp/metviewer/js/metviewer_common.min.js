...
a.append($("<caption_offset />").text($("#caption_offset").val()));a.append($("<caption_align />").text($("#caption_align").val()));a.append($("<ci_alpha />").text($("#ci_alpha").val()));a.append($("<eqbound_low />").text($("#eqbound_low").val()));a.append($("<eqbound_high />").text($("#eqbound_high").val()));var g=sortSeries();b=[];d=[];c=[];f=[];var h=[],l=[],p=[],m=[],q=[],t=[],u=[],x=[];for(e=0;e<g.length;e++)if(""!==g[e].order)b.push('"'+g[e].plot_ci+'"'),"No"===g[e].hide?d.push("TRUE"):d.push("FALSE"),
"No"===g[e].show_signif?u.push("FALSE"):u.push("TRUE"),c.push('"'+g[e].color+'FF"'),f.push(g[e].pch),h.push('"'+g[e].type+'"'),l.push(g[e].lty),p.push(g[e].lwd),m.push(g[e].con_series),q.push(g[e].order),t.push('"'+g[e].legend+'"');else{var v=g[e].title,z=v.split("(")[0];v=v.split("(")[1].split(")")[0];x.push($("<line />").attr("type",z).attr("line_pos",v).attr("color",g[e].color).attr("lty",g[e].lty).attr("lwd",g[e].lwd))}if(0<x.length){e=$("<lines />");for(g=0;g<x.length;g++)e.append(x[g]);a.append(e)}a.append($("<plot_ci />").text("c("+
b.join()+")"));a.append($("<show_signif />").text("c("+u.join()+")"));a.append($("<plot_disp />").text("c("+d.join()+")"));a.append($("<colors />").text("c("+c.join()+")"));a.append($("<pch />").text("c("+f.join()+")"));a.append($("<type />").text("c("+h.join()+")"));a.append($("<lty />").text("c("+l.join()+")"));a.append($("<lwd />").text("c("+p.join()+")"));a.append($("<con_series />").text("c("+m.join()+")"));a.append($("<order_series />").text("c("+q.join()+")"));a.append($("<plot_cmd />").text($("#plot_cmd").val()));
...
h=$(initXML.find("plot").find("mar")).text().replace("c(","").replace(")","").split(","),$("#mar_bottom").val(h[0]),$("#mar_left").val(h[1]),$("#mar_top").val(h[2]),$("#mar_right").val(h[3]),h=$(initXML.find("plot").find("mgp")).text().replace("c(","").replace(")","").split(","),$("#mgp_title").val(h[0]),$("#mgp_labels").val(h[1]),$("#mgp_line").val(h[2]),$("#title_align").val($(initXML.find("plot").find("title_align")).text()),$("#title_offset").val($(initXML.find("plot").find("title_offset")).text()),
...
$("#ytlab_horiz").val($(initXML.find("plot").find("ytlab_horiz")).text()),$("#ytlab_perp").val($(initXML.find("plot").find("ytlab_perp")).text()),$("#ytlab_size").val($(initXML.find("plot").find("ytlab_size")).text()),$("#ytlab_orient").val($(initXML.find("plot").find("ytlab_orient")).text()),h=$(initXML.find("plot").find("y1_lim")).text().replace("c(","").replace(")","").split(","),$("#y1_lim_min").val(h[0]),$("#y1_lim_max").val(h[1]),$("#y1_bufr").val($(initXML.find("plot").find("y1_bufr")).text()),
h=$(initXML.find("plot").find("x1_lim")).text().replace("c(","").replace(")","").split(","),$("#x1_lim_min").val(h[0]),$("#x1_lim_max").val(h[1]),$("#y2lab_align").val($(initXML.find("plot").find("y2lab_align")).text()),$("#y2lab_offset").val($(initXML.find("plot").find("y2lab_offset")).text()),$("#y2lab_size").val($(initXML.find("plot").find("y2lab_size")).text()),$("#y2lab_weight").val($(initXML.find("plot").find("y2lab_weight")).text()),$("#y2tlab_horiz").val($(initXML.find("plot").find("y2tlab_horiz")).text()),
$("#y2tlab_perp").val($(initXML.find("plot").find("y2tlab_perp")).text()),$("#y2tlab_size").val($(initXML.find("plot").find("y2tlab_size")).text()),$("#y2tlab_orient").val($(initXML.find("plot").find("y2tlab_orient")).text()),h=$(initXML.find("plot").find("y2_lim")).text().replace("c(","").replace(")","").split(","),$("#y2_lim_min").val(h[0]),$("#y2_lim_max").val(h[1]),$("#y2_bufr").val($(initXML.find("plot").find("y1_bufr")).text()),$("#legend_size").val($(initXML.find("plot").find("legend_size")).text()),
h=$(initXML.find("plot").find("legend_inset")).text().replace("c(","").replace(")","").split(","),$("#legend_inset_min").val(h[0]),$("#legend_inset_max").val(h[1]),$("#legend_box").val($(initXML.find("plot").find("legend_box")).text()),$("#legend_ncol").val($(initXML.find("plot").find("legend_ncol")).text()),$("#caption_align").val($(initXML.find("plot").find("caption_align")).text()),$("#caption_offset").val($(initXML.find("plot").find("caption_offset")).text()),$("#caption_size").val($(initXML.find("plot").find("caption_size")).text()),
$("#caption_weight").val($(initXML.find("plot").find("caption_weight")).text()),h=$(initXML.find("plot").find("caption_col")).text(),7<h.length&&(h=h.substring(0,7)),$("#caption_col").colorpicker("setColor",h)):resetFormatting();$("#release").on("click",function(){var a=window.open("https://metviewer.readthedocs.io/en/latest/");a?a.focus():alert("Please allow popups for this site")});g=$("#categories11");for(h=0;h<categories.length;h++){var p=$(categories[h]);l=$('<ul data-label="'+p.attr("name")+
'">');p=p.find("db");for(var m=0;m<p.length;m++){var q=$(p[m]),t=q.find("val"),u=q.find("desc");q=$('<li data-value="'+t.text()+'" title="'+u.text()+'">');t=$('<input name="multiselect_database" type="checkbox" disabled value="'+t.text()+'" title="'+u.text()+'" id="'+t.text()+'" /><label for="'+t.text()+'" >'+t.text()+"</label>lab");q.prepend(t);l.append(q)}g.append(l)}$(".multilevel-dropdown").multilevelDropdown();$("input[name='multiselect_database']").on("change",function(a){if(null!=$(this).val()){var b=
