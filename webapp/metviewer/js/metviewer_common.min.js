...
function addFixedVar(){var a;a=0<fixed_var_indexes.length?parseInt(fixed_var_indexes[fixed_var_indexes.length-1]):(a=$("#fixed_var_table select:first-child"))?parseInt(a.prop("id").split("fixed_var_")[1]):1;var b=a,c,e,d,f,g,h,k;(e="none"===$("#fixed_var_table").css("display"))?(0===fixed_var_indexes.length&&fixed_var_indexes.push(b),$("#fixed_var_table").css("display",""),c=$("#fixed_var_"+b),$("#remove_fixed_var_"+b).button({icons:{primary:"ui-icon-trash"},text:!1}),d=$("#fixed_var_val_"+b),f=$("#fixed_var_val_date_period_button_"+
b),g=$("#fixed_var_val_date_period_"+b),$("#fix_var_event_equal_"+b).prop("checked",!0)):(b=parseInt(a)+1,fixed_var_indexes.push(b),c=$("#fixed_var_"+a).clone(!1),c.prop("id","fixed_var_"+b),c.css("display",""),c.val(c.find(" option:first").val()));e||(e=$("#remove_fixed_var_"+a).clone(!0).prop("id","remove_fixed_var_"+b),d=$("#fixed_var_val_"+a).clone(!1),d.prop("id","fixed_var_val_"+b),d.css("display",""),c.val(c.find(" option:first").val()),f=$("<button>",{text:"Select multiple options",id:"fixed_var_val_date_period_button_"+
b}).css("display","none"),g=$("#fixed_var_val_date_period_"+a).clone(!1).appendTo("body"),g.prop("id","fixed_var_val_date_period_"+b),g.find("#fixed_var_val_date_period_start_"+a).prop("id","fixed_var_val_date_period_start_"+b),g.find("#fixed_var_val_date_period_end_"+a).prop("id","fixed_var_val_date_period_end_"+b),g.find("#fixed_var_val_date_period_by_"+a).prop("id","fixed_var_val_date_period_by_"+b),g.find("#fixed_var_val_date_period_by_unit_"+a).prop("id","fixed_var_val_date_period_by_unit_"+
b),h=$("#fix_var_event_equal_"+a).clone(!0).prop("id","fix_var_event_equal_"+b).prop("checked",!0),0<$("#fix_var_event_equal_"+a).find("label").size()&&(k=$('<label for="fix_var_event_equal_'+b+'">Equalize</label>')),$("body").append(g),$("#fixed_var_table").append($("<tr>").append($("<td>").append(e)).append($("<td>").append(c)).append($("<td>").append(d)).append($("<td>").append(f)).append($("<td>").append(h).append(k))));createValDatePeriodDialog("fixed_var_val",b);d.multiselect({selectedList:100,
noneSelectedText:"Select value",position:{my:"center center",at:"right center"}});c.multiselect({multiple:!1,selectedList:1,header:!1,minWidth:"auto",height:"auto",click:function(a,d){$("#fixed_var_val_date_period_start_"+b).empty();$("#fixed_var_val_date_period_end_"+b).empty();"fcst_init_beg"===d.value||"fcst_valid_beg"===d.value||"fcst_valid"===d.value||"fcst_init"===d.value?$("#fixed_var_val_date_period_button_"+b).css("display","block"):$("#fixed_var_val_date_period_button_"+b).css("display",
"none");var c=this.id.split("_");updateFixedVarVal(c[c.length-1],[])}});f.button({icons:{primary:"ui-icon-check",secondary:"ui-icon-circlesmall-plus"},text:!1}).click(function(){$("#fixed_var_val_date_period_"+b).dialog("open")});updateFixedVarVal(b,[])}
