...
"y1"),0);0===n.length&&(n[0]="");if("Roc"===currentTab||"Rely"===currentTab||"Eclv"===currentTab){try{var r=$("#summary_curve").multiselect("getChecked")}catch(w){r=[]}for(l=0;l<r.length;l++)"none"!=r[l].value&&n.push(r[l].value)}for(var y=0;y<n.length;y++){r=n[y]+" "+A;var B=!1;for(l=0;l<b.length;l++)if(b[l].title==r){e={};e.title=r;e.y_axis="Y1";e.order=d+1;e.hide=b[l].hide;e.plot_ci=b[l].plot_ci;e.show_signif=b[l].show_signif;e.color=b[l].color;e.pch=b[l].pch;e.type=b[l].type;e.lty=b[l].lty;e.lwd=
b[l].lwd;e.con_series=b[l].con_series;e.legend=b[l].legend;e.id=d+1;B=!0;break}B||(c&&0<d&&null==initXML?(e=jQuery.extend(!0,{},f[f.length-1]),e.title=r,e.y_axis="Y1",e.id=d+1,e.order=d+1):null!=initXML?(e={},e.title=r,e.y_axis="Y1",e.order=x[d]&&""!=x[d]?parseInt(x[d]):parseInt(l+1),e.hide=k[d],e.plot_ci=g[d].trim(),e.show_signif=h[d],e.pch=m[d].trim(),e.type=z[d].trim(),e.lty=q[d].trim(),e.lwd=t[d].trim(),e.con_series=u[d].trim(),e.legend=v[d].trim(),e.color=p[d].trim(),e.id=d+1):(e=jQuery.extend(!0,
{},firstSeriesFormatting),e.title=r,e.y_axis="Y1",e.id=d+1,e.order=d+1));d++;f.push(e)}for(l=0;l<lines.length;l++)e=jQuery.extend(!0,{},firstSeriesFormatting),e.title=lines[l].type+"("+lines[l].line_pos+")",e.y_axis="Y1",e.order="",e.id=d+1,lines[l].hasOwnProperty("color")&&(e.color=lines[l].color),lines[l].hasOwnProperty("lty")&&(e.lty=lines[l].lty),lines[l].hasOwnProperty("lwd")&&(e.lwd=lines[l].lwd),d++,f.push(e);if(null==initXML)for(p=rainbow(f.length),l=0;l<f.length;l++)f[l].color=p[l];f.sort(SortByOrder);
for(l=0;l<f.length;l++)a.jqGrid("addRowData",l+1,f[l]);outerLayout.sizePane("south",$("#gbox_listdt").height())}
...
"").replace(/\)$/,"").replace(/"/g,"").split(",");if(z.length!=v.length)for(d=0;d<v.length;d++)z[d]=""}d=permuteSeries(createSeriesMapForPermutationEns(series_var_y1_indexes,"y1"),0);if("true"===$("input:radio[name='ensss_pts_disp']:checked").val()){var l=[];var r=0;for(n=0;n<d.length;n++)l[r]=d[n]+" MSE",l[r+1]=d[n]+" #PTS",r+=2;d=l}else for(n=0;n<d.length;n++)d[n]+=" MSE";for(r=0;r<d.length;r++){var y=d[r],B=!1;l=0<y.indexOf("#PTS")?"Y2":"Y1";for(n=0;n<b.length;n++)if(b[n].title==y){c={};c.title=
y;c.y_axis=l;c.order=e+1;c.hide=b[n].hide;c.plot_ci=b[n].plot_ci;c.show_signif=b[n].show_signif;c.color=b[n].color;c.pch=b[n].pch;c.type=b[n].type;c.lty=b[n].lty;c.lwd=b[n].lwd;c.con_series=b[n].con_series;c.legend=b[n].legend;c.id=e+1;B=!0;break}B||(f&&0<e&&null==initXML?(c=jQuery.extend(!0,{},g[g.length-1]),c.title=y,c.y_axis=l,c.id=e+1,c.order=e+1):null!=initXML?(c={},c.title=y,c.y_axis=l,c.order=v[e]&&""!=v[e]?parseInt(v[e]):parseInt(n+1),c.hide=h[e],c.plot_ci=k[e].trim(),c.show_signif=p[e],c.pch=
q[e].trim(),c.type=A[e].trim(),c.lty=t[e].trim(),c.lwd=u[e].trim(),c.con_series=x[e].trim(),c.legend=z[e].trim(),c.color=m[e].trim(),c.id=e+1):(c=jQuery.extend(!0,{},firstSeriesFormatting),c.title=y,c.y_axis=l,c.id=e+1,c.order=e+1));e++;g.push(c)}for(n=0;n<lines.length;n++)c=jQuery.extend(!0,{},firstSeriesFormatting),c.title=lines[n].type+"("+lines[n].line_pos+")",c.y_axis="Y1",c.order="",c.id=e+1,lines[n].hasOwnProperty("color")&&(c.color=lines[n].color),lines[n].hasOwnProperty("lty")&&(c.lty=lines[n].lty),
...
"").replace(")","").replace(/"/g,"").split(",");for(var n=0;n<h.length;n++)"TRUE"==h[n].trim()?h[n]="No":h[n]="Yes","TRUE"==p[n].trim()?p[n]="No":p[n]="Yes";m=initXML.find("plot").find("colors").text().replace("c(","").replace(")","").replace(/"/g,"").split(",");for(n=0;n<m.length;n++)m[n]=m[n].replace(/FF$/,"");q=initXML.find("plot").find("pch").text().replace("c(","").replace(")","").replace(/"/g,"").split(",");t=initXML.find("plot").find("lty").text().replace("c(","").replace(")","").replace(/"/g,
"").split(",");u=initXML.find("plot").find("lwd").text().replace("c(","").replace(")","").replace(/"/g,"").split(",");x=initXML.find("plot").find("con_series").text().replace("c(","").replace(")","").replace(/"/g,"").split(",");v=initXML.find("plot").find("order_series").text().replace("c(","").replace(")","").replace(/"/g,"").split(",");A=initXML.find("plot").find("type").text().replace("c(","").replace(")","").replace(/"/g,"").split(",");z=initXML.find("plot").find("legend").text().replace("c(",
"").replace(/\)$/,"").replace(/"/g,"").split(",");if(z.length!=v.length)for(d=0;d<v.length;d++)z[d]=""}d=permuteSeries(createSeriesMapForPermutationEns(series_var_y1_indexes,"y1"),0);for(var l=0;l<d.length;l++){var r=d[l],y=!1;for(n=0;n<b.length;n++)if(b[n].title==r){c={};c.title=r;c.y_axis="";c.order=e+1;c.hide=b[n].hide;c.plot_ci=b[n].plot_ci;c.show_signif=b[n].show_signif;c.color=b[n].color;c.pch=b[n].pch;c.type=b[n].type;c.lty=b[n].lty;c.lwd=b[n].lwd;c.con_series=b[n].con_series;c.legend=b[n].legend;
c.id=e+1;y=!0;break}y||(f&&0<e&&null==initXML?(c=jQuery.extend(!0,{},g[g.length-1]),c.title=r,c.y_axis=void 0,c.id=e+1,c.order=e+1):null!=initXML?(c={},c.title=r,c.y_axis=void 0,c.order=v[e]&&""!=v[e]?parseInt(v[e]):parseInt(n+1),c.hide=h[e],c.plot_ci=k[e].trim(),c.show_signif=p[e],c.pch=q[e].trim(),c.type=A[e].trim(),c.lty=t[e].trim(),c.lwd=u[e].trim(),c.con_series=x[e].trim(),c.legend=z[e].trim(),c.color=m[e].trim(),c.id=e+1):(c=jQuery.extend(!0,{},firstSeriesFormatting),c.title=r,c.y_axis=void 0,
...
function updateSeries(a){var b=$("#listdt");b.saveCell(lastSelRow,lastSelCol);var d=b.jqGrid("getRowData");b.jqGrid("clearGridData");group_name_to_value_map={};var e=0,c={},f=$("#seriesLock").is(":checked"),g=[],k=$("#plot_data").multiselect("getChecked").val(),h=[],p=[],m=[],q=[],t=[],u=[],x=[],v=[],z=[],A=[],n=[];if(null!=initXML){h=initXML.find("plot").find("plot_ci").text().replace("c(","").replace(")","").replace(/"/g,"").split(",");p=initXML.find("plot").find("plot_disp").text().replace("c(",
...
else for(z=[],l=0;l<q.length;l++)z.push(l+1);n=initXML.find("plot").find("type").text().replace("c(","").replace(")","").replace(/"/g,"").split(",");A=initXML.find("plot").find("legend").text().replace("c(","").replace(/\)$/,"").replace(/"/g,"").split(",");if(A.length!=z.length)for(l=0;l<z.length;l++)A[l]=""}for(var r=1;2>=r;r++){var y="y"+r;if(1==r){var B=fcst_var_y1_indexes;var w=permuteSeries(createSeriesMapForPermutation(series_var_y1_indexes,y),0)}else B=fcst_var_y2_indexes,w=permuteSeries(createSeriesMapForPermutation(series_var_y2_indexes,
y),0);for(var G=0;G<B.length;G++){var L=$("#fcst_var_"+y+"_"+B[G]).val(),J=[];var D=$("#fcst_stat_"+y+"_"+B[G]).multiselect("getChecked");var E=[];if("Contour"==currentTab){for(l=0;l<fixed_var_indexes.length;l++){var F=$("#fixed_var_val_"+fixed_var_indexes[l]).val();if(F)for(w=0;w<F.length;w++)E.push({value:F[w]})}w=[""]}E&&0!=E.length||(E=[{value:""}]);0!=D.length||"mode"!=k&&"mtd"!=k||(D=$("#fcst_stat_mode_"+y+"_"+B[G]).multiselect("getChecked"));for(l=0;l<D.length;l++)J.push(D[l].value);for(D=
0;D<J.length;D++)for(F=0;F<w.length;F++){l=J[D];if("mode"==k&&-1==listStatModeRatio.indexOf(l)||"mtd"==k&&-1==listStatMtdRatio.indexOf(l))l=createStatNameForModeArrt(l,y,B[G]);for(var M=w[F]+" "+L+" "+l,I=0;I<E.length;I++){var C=M;-1<C.indexOf("<")&&(C=C.replace(/</g,"&lt;"));0<E[I].value.length&&(C=C+" "+E[I].value);var K=!1;for(l=0;l<d.length;l++)if(d[l].title==C&&d[l].y_axis.match(r+"$")==r){c={};c.title=C;c.y_axis="Y"+r;c.order=e+1;c.hide=d[l].hide;c.plot_ci=d[l].plot_ci;c.show_signif=d[l].show_signif;
c.color=d[l].color;c.pch=d[l].pch;c.type=d[l].type;c.lty=d[l].lty;c.lwd=d[l].lwd;c.con_series=d[l].con_series;c.legend=d[l].legend;c.id=e+1;K=!0;break}K||(f&&0<e&&null==initXML?(c=jQuery.extend(!0,{},g[g.length-1]),c.title=C,c.y_axis="Y"+r,c.id=e+1,c.order=e+1):null!=initXML?(c={},c.title=C,c.y_axis="Y"+r,c.order=parseInt(z[e]),c.hide=p[e],c.plot_ci=h[e].trim(),c.show_signif=m[e],c.pch=t[e].trim(),c.type=n[e].trim(),c.lty=u[e].trim(),c.lwd=x[e].trim(),c.con_series=v[e].trim(),c.legend=A[e].trim(),
c.color=q[e].trim(),c.id=e+1):(c=f&&0<d.length?jQuery.extend(!0,{},d[d.length-1]):jQuery.extend(!0,{},firstSeriesFormatting),c.title=C,c.y_axis="Y"+r,c.id=e+1,c.order=e+1));"Contour"!==currentTab&&e++;g.push(c)}}}}d=[];for(l=0;l<seriesDiffY1.length;l++){c=seriesDiffY1[l].split(",")[0];k=seriesDiffY1[l].split(",")[1];r=seriesDiffY1[l].split(",")[2];B=y=!1;var H='"and"';"DIFF"===r?H='"-"':"RATIO"===r&&(H='"/"');for(w=0;w<g.length;w++)c==g[w].title&&(y=!0),k==g[w].title&&(B=!0);y&&B&&(d.push(seriesDiffY1[l]),
k=r+' ("'+c+H+k+'")',f&&null==initXML?(c=jQuery.extend(!0,{},g[g.length-1]),c.title=k,c.y_axis="Y1",c.id=e+1,c.order=e+1):null!=initXML?(c={},c.title=k,c.y_axis="Y1",c.order=parseInt(z[e]),c.hide=p[e],c.plot_ci=h[e].trim(),c.show_signif=m[e].trim(),c.pch=t[e].trim(),c.type=n[e].trim(),c.lty=u[e].trim(),c.lwd=x[e].trim(),c.con_series=v[e].trim(),c.legend=A[e].trim(),c.color=q[e].trim(),c.id=e+1):(c=jQuery.extend(!0,{},firstSeriesFormatting),c.title=k,c.y_axis="Y1",c.id=e+1,c.order=e+1),e++,g.push(c))}seriesDiffY1=
d;d=[];for(l=0;l<seriesDiffY2.length;l++){c=seriesDiffY2[l].split(",")[0];k=seriesDiffY2[l].split(",")[1];r=seriesDiffY1[l].split(",")[2];B=y=!1;"DIFF"===r?H='"-"':"RATIO"===r&&(H='"/"');for(w=0;w<g.length;w++)c==g[w].title&&(y=!0),k==g[w].title&&(B=!0);y&&B&&(d.push(seriesDiffY2[l]),k=r+' ("'+c+H+k+'")',f&&null==initXML?(c=jQuery.extend(!0,{},g[g.length-1]),c.title=k,c.y_axis="Y2",c.id=e+1,c.order=e+1):null!=initXML?(c={},c.title=k,c.y_axis="Y2",c.order=parseInt(z[e]),c.hide=p[e],c.plot_ci=h[e].trim(),
c.show_signif=m[e],c.pch=t[e].trim(),c.type=n[e].trim(),c.lty=u[e].trim(),c.lwd=x[e].trim(),c.con_series=v[e].trim(),c.legend=A[e].trim(),c.color=q[e].trim(),c.id=e+1):(c=jQuery.extend(!0,{},firstSeriesFormatting),c.title=k,c.y_axis="Y2",c.id=e+1,c.order=e+1),e++,g.push(c))}seriesDiffY2=d;for(l=0;l<lines.length;l++)c=jQuery.extend(!0,{},firstSeriesFormatting),c.title=lines[l].type+"("+lines[l].line_pos+")",c.y_axis="Y1",c.order="",c.id=e+1,lines[l].hasOwnProperty("color")&&(c.color=lines[l].color),
lines[l].hasOwnProperty("lty")&&(c.lty=lines[l].lty),lines[l].hasOwnProperty("lwd")&&(c.lwd=lines[l].lwd),e++,g.push(c);if(null==initXML){if("Contour"===currentTab)for(l=0;l<g.length;l++)q.push("#000000");else q=rainbow(g.length);e=[];if(a)e=q;else{for(l=0;l<q.length;l++)for(w=0;w<g.length;w++)g[w].color&&0<g[w].color.length&&g[w].color.substr(g[w].color.length-6).toUpperCase()===q[l].substr(q[l].length-6).toUpperCase()&&l!=w&&(e[w]=q[l],e[l]=q[w]);for(l=0;l<q.length;l++)e[l]||(e[l]=q[l])}for(l=0;l<
g.length;l++)g[l].color&&0!=g[l].color.length||(g[l].color=e[l])}"Contour"===currentTab?g.reverse():g.sort(SortByOrder);for(l=0;l<g.length;l++)b.jqGrid("addRowData",l+1,g[l]),"Contour"===currentTab&&0!==l&&$("#"+(l+1),"#gbox_listdt").css({display:"none"});outerLayout.sizePane("south",$("#gbox_listdt").height())}function SortByOrder(a,b){return a.order-b.order}
...
e));a.append($("<caption_size />").text($("#caption_size").val()));a.append($("<caption_offset />").text($("#caption_offset").val()));a.append($("<caption_align />").text($("#caption_align").val()));a.append($("<ci_alpha />").text($("#ci_alpha").val()));a.append($("<eqbound_low />").text($("#eqbound_low").val()));a.append($("<eqbound_high />").text($("#eqbound_high").val()));var g=sortSeries();b=[];d=[];c=[];f=[];var k=[],h=[],p=[],m=[],q=[],t=[],u=[],x=[];for(e=0;e<g.length;e++)if(""!==g[e].order)b.push('"'+
g[e].plot_ci+'"'),"No"===g[e].hide?d.push("TRUE"):d.push("FALSE"),"No"===g[e].show_signif?u.push("FALSE"):u.push("TRUE"),c.push('"'+g[e].color+'FF"'),f.push(g[e].pch),k.push('"'+g[e].type+'"'),h.push(g[e].lty),p.push(g[e].lwd),m.push(g[e].con_series),q.push(g[e].order),t.push('"'+g[e].legend+'"');else{var v=g[e].title,z=v.split("(")[0];v=v.split("(")[1].split(")")[0];x.push($("<line />").attr("type",z).attr("line_pos",v).attr("color",g[e].color).attr("lty",g[e].lty).attr("lwd",g[e].lwd))}if(0<x.length){e=
$("<lines />");for(g=0;g<x.length;g++)e.append(x[g]);a.append(e)}a.append($("<plot_ci />").text("c("+b.join()+")"));a.append($("<show_signif />").text("c("+u.join()+")"));a.append($("<plot_disp />").text("c("+d.join()+")"));a.append($("<colors />").text("c("+c.join()+")"));a.append($("<pch />").text("c("+f.join()+")"));a.append($("<type />").text("c("+k.join()+")"));a.append($("<lty />").text("c("+h.join()+")"));a.append($("<lwd />").text("c("+p.join()+")"));a.append($("<con_series />").text("c("+
...
$(this).getRowData(a);if(b.title.startsWith("vert_line")||b.title.startsWith("horiz_line")){$(this).jqGrid("delRowData",a);a=null;for(var c=0;c<lines.length;c++){var d=b.title,e=d.split("(")[0];d=d.split("(")[1].split(")")[0];if(lines[c].type===e&&lines[c].line_pos===d){a=c;break}}null!==a&&lines.splice(a,1)}}else b="#alertmod_"+this.p.id,$.jgrid.viewModal(b,{gbox:"#gbox_"+$.jgrid.jqID(this.p.id),jqm:!0}),$(b).find(".ui-jqdialog-titlebar-close").focus()}}).jqGrid("navButtonAdd","#pagerdt",{caption:"Apply defaults",
title:"Apply defaults",buttonicon:"ui-icon-transferthick-e-w",onClickButton:function(){alert("defaults..")}});$("#listdt").setGridWidth($(window).width()-20);var d=$("#unavailableDiffCurveDialogForm").dialog({autoOpen:!1,height:"auto",width:"auto",modal:!0,buttons:{Ok:function(){d.dialog("close")}}}),e=$("#unavailableLineDialogForm").dialog({autoOpen:!1,height:"auto",width:"auto",modal:!0,buttons:{Ok:function(){e.dialog("close")}}}),c=$("#incorrectDiffCurveDialogForm").dialog({autoOpen:!1,height:"auto",
width:"auto",modal:!0,buttons:{Ok:function(){c.dialog("close")}}});$(window).bind("resize",function(){$("#listdt").setGridWidth($(window).width()-20)}).trigger("resize");$("#listdt").jqGrid("sortableRows",{update:function(a,b){a=$("#listdt").jqGrid("getRowData");for(b=0;b<a.length;b++)$("#listdt").jqGrid("setCell",a[b].id,"order",b+1),$("#listdt").jqGrid("getLocalRow",a[b].id).order=b+1}});$("#pagerdt_left table.navtable tbody tr").append('<td><div ><input type="checkbox"  style="margin:0 4px;" id="seriesLock"/><label for="seriesLock">Lock Formatting</label></div></td>');
...
d=parseInt(d);"min"===e?d*=60:"hours"===e?d*=3600:"days"===e&&(d*=86400);e=moment.tz(a.date1,"UTC");var k=moment.tz(a.date2,"UTC");g.multiselect("uncheckAll");for(var h=$('[name="multiselect_indy_var_val"]');e<=k;){for(var p=e.format("YYYY-MM-DD HH:mm:ss"),m=!1,q=0;q<c.length;q++)if($(c[q]).text()===p){m=!0;break}if(m){try{var t=e.format(f)}catch(x){console.log("formatting error"),console.error(x),t=p}m=g.find('option[value="'+p+'"]');m.prop("selected",!0);if(!b)for(indy_var_vals_to_attr={},q=0;q<
h.length;q++){var u=$(h[q]);if(u.attr("value")===p){p=u.attr("id");$("#"+p+"_label").val(t);indy_var_vals_to_attr[h[q].value]=a;break}}m.text(t)}e.add(d,"seconds")}b&&g.multiselect("option","indy_var_vals_to_attr",indy_var_vals_to_attr);try{g.multiselect("refresh")}catch(x){console.log(x)}}
