...
$("input[name=statistics][value=calculations_statistics]").prop("checked",!0);$("#calc_stat").val("none");try{$("#calc_stat").multiselect("refresh")}catch(c){}$("#aggregation_statistics ").hide();$("#calculations_statistics ").show();updateSeries()}});c&&(f=$("#fcst_stat_mode_config_"+a+"_"+b),f.css("display","block"),"ACOV"==l?f.find(".non-acov").attr("disabled",!0):f.find(".non-acov").removeAttr("disabled"),2==p.length&&(p="A"+p),"ACOV"==l?"A"==p[0]?(f.find('[name="mode_stat_fcst"]').prop("checked",
...
!0)):"F"==p[0]?(f.find('[name="mode_stat_diff"]').prop("checked",!1),f.find('[name="mode_stat_fcst"]').prop("checked",!0),f.find('[name="mode_stat_obs"]').prop("checked",!1)):"O"==p[0]&&(f.find('[name="mode_stat_diff"]').prop("checked",!1),f.find('[name="mode_stat_fcst"]').prop("checked",!1),f.find('[name="mode_stat_obs"]').prop("checked",!0)),"A"==p[1]?(f.find('[name="mode_stat_simple"]').prop("checked",!0),f.find('[name="mode_stat_cluster"]').prop("checked",!0)):"S"==p[1]?(f.find('[name="mode_stat_simple"]').prop("checked",
!0),f.find('[name="mode_stat_cluster"]').prop("checked",!1)):"C"==p[1]&&(f.find('[name="mode_stat_simple"]').prop("checked",!1),f.find('[name="mode_stat_cluster"]').prop("checked",!0)),"A"==p[2]?(f.find('[name="mode_stat_matched"]').prop("checked",!0),f.find('[name="mode_stat_unmatched"]').prop("checked",!0)):"M"==p[2]?(f.find('[name="mode_stat_matched"]').prop("checked",!0),f.find('[name="mode_stat_unmatched"]').prop("checked",!1)):"U"==p[2]&&(f.find('[name="mode_stat_matched"]').prop("checked",
!1),f.find('[name="mode_stat_unmatched"]').prop("checked",!0))),-1<listStatModePair.indexOf(l)?f.find(".non-pair").attr("disabled",!0):f.find(".non-pair").removeAttr("disabled"));if("N/A"==d){try{e.multiselect("disable")}catch(r){}try{k.multiselect("disable")}catch(r){}}else{try{e.multiselect("enable")}catch(r){}try{k.multiselect("enable")}catch(r){}}e=$("#series_var_"+a+"_"+b);e.empty();$.each(fix_var_value_to_title_mode_map,function(a,b){e.append('<option value="'+a+'">'+b+"</option>")});try{e.multiselect("refresh")}catch(r){}}
...
b.append($("<eveq_dis />").text($("#eveq_dis").is(":checked"))),b.append($("<cache_agg_stat />").text($("#cacheAggStat").is(":checked"))),a.append(b)):"calculations_statistics"===c&&"none"!==b&&(e=$("<calc_stat />"),e.append($("<calc_"+b+" />").text("true")),a.append(e));a.append($("<plot_stat />").text($("#plot_stat").val()));return a}
...
h){k=!0;break}k&&b.append($("<val />").attr("label",h).attr("plot_val","").text(h));g.add(f,"hour")}}a.append(b);e=$("input:radio[name ='statistics']:checked").val();b=$("#calc_stat").val();c=$("#agg_stat").val();"aggregation_statistics"===e&&"none"!==c?(b=$("<agg_stat />"),b.append($("<agg_"+c+" />").text("true")),b.append($("<boot_repl />").text($("#boot_repl").val())),b.append($("<boot_ci />").text($("#boot_ci").val())),b.append($("<eveq_dis />").text($("#eveq_dis").is(":checked"))),b.append($("<cache_agg_stat />").text($("#cacheAggStat").is(":checked"))),
a.append(b)):"calculations_statistics"===e&&"none"!==b&&(c=$("<calc_stat />"),c.append($("<calc_"+b+" />").text("true")),a.append(c));a.append($("<plot_stat />").text($("#plot_stat").val()));return a}
...
click:function(a,b){var d=this.id.split("_");$("#fcst_stat_mode_config_"+d[d.length-2]+"_"+d[d.length-1]).css("display","none");try{$("#fcst_stat_mode_"+d[d.length-2]+"_"+d[d.length-1]).multiselect("uncheckAll")}catch(c){console.log("Error "+c)}$("input[name=statistics][value=aggregation_statistics]").prop("checked",!0);$("#agg_stat").val("mode");try{$("#agg_stat").multiselect("refresh")}catch(c){}$("#aggregation_statistics ").show();$("#calculations_statistics ").hide();updateSeries()},checkAll:function(){updateSeries()},
uncheckAll:function(){updateSeries()}}),"N/A"==$("#fcst_var_"+a+"_"+(b+1)).multiselect("getChecked").val()?f.multiselect("disable"):f.multiselect("enable"),g.multiselect({multiple:!1,selectedList:1,header:!1,minWidth:225,height:300,noneSelectedText:"Select attribute stat",allUnselected:!0,position:{my:"right center",at:"right center"},click:function(a,b){var d=this.id.split("_");try{$("#fcst_stat_"+d[d.length-2]+"_"+d[d.length-1]).multiselect("uncheckAll")}catch(c){}d=$("#fcst_stat_mode_config_"+
d[d.length-2]+"_"+d[d.length-1]);d.css("display","block");"ACOV"==b.value?d.find(".non-acov").attr("disabled",!0):d.find(".non-acov").removeAttr("disabled");-1<listStatModePair.indexOf(b.value)?d.find(".non-pair").attr("disabled",!0):d.find(".non-pair").removeAttr("disabled");$("input[name=statistics][value=calculations_statistics]").prop("checked",!0);$("#calc_stat").val("none");try{$("#calc_stat").multiselect("refresh")}catch(c){}$("#aggregation_statistics ").hide();$("#calculations_statistics ").show();
updateSeries()}}))}
...
a+'">'+b+"</option>")}):$.each(fix_var_value_to_title_mode_map,function(a,b){$("#fixed_var_1").append('<option value="'+a+'">'+b+"</option>")});var c,e;e="Perf"===currentTab||"Taylor"===currentTab?1:2;for(var d,f=1;f<=e;f++){var g="y"+f,h=0;if(0<initXML.find("plot").find("dep").find("dep"+f).children().length)for(var k=initXML.find("plot").find("dep").find("dep"+f).children(),a=0;a<k.length;a++){d=[];c=$(k[a]).attr("name");0===h&&1===f||addFcstVar(g);try{$("#fcst_var_"+g+"_"+(h+1)).val(c).multiselect("refresh")}catch(r){}$(k[a]).find("stat").each(function(){d.push($(this).text())});
if("stat"===b)updateStats(g,h+1,d),h++;else if($.isArray(d))for(c=0;c<d.length;c++){if(0<c){addFcstVar(g);try{$("#fcst_var_"+g+"_"+(h+1)).val($(k[a]).attr("name")).multiselect("refresh")}catch(r){}}updateMode(g,h+1,d[c]);h++}else updateMode(g,h+1,d),h++}else"stat"===b?updateStats(g,1,""):updateMode(g,1,"");var l,p;if(0<initXML.find("plot").find("series"+f).children().length)for(h=initXML.find("plot").find("series"+f).children(),a=0;a<h.length;a++){l=[];p=!1;c=$(h[a]).attr("name");if(0!==a||1!==f)"Taylor"===
currentTab?addSeriesVarRhist():addSeriesVar(g);try{$("#series_var_"+g+"_"+(a+1)).val(c).multiselect("refresh")}catch(r){}$(h[a]).find("val").each(function(){var a=$(this).text().split(",");1<a.length&&(p=!0);for(var b=0;b<a.length;b++)l.push(a[b])});"fcst_init_beg"==c||"fcst_valid_beg"==c||"fcst_valid"==c||"fcst_init"==c?$("#series_var_val_"+g+"_date_period_button_"+(a+1)).css("display","block"):$("#series_var_val_"+g+"_date_period_button_"+(a+1)).css("display","none");updateSeriesVarVal(g,a+1,l);
p&&$("#group_series_var_"+g+"_"+(a+1)).prop("checked",!0)}else l=$("#series_var_"+g+"_1").first().val(),updateSeriesVarVal(g,1,l)}updatePlotFixSeries();$("#txtPlotCond").val(initXML.find("plot").find("plot_cond").text());"mode"===b&&updateIndyVar(b);c=$(initXML.find("plot").find("indep")[0]).attr("name");try{$("#indy_var").val(c).multiselect("refresh")}catch(r){}"fcst_init_beg"==c||"fcst_valid_beg"==c||"fcst_valid"==c||"fcst_init"==c?$("#date_period_button").css("display","block"):$("#date_period_button").css("display",
...
$("#agg_stat").val("nbrcnt"):"TRUE"===$(initXML.find("plot").find("agg_stat").find("agg_ssvar")).text()?$("#agg_stat").val("ssvar"):"TRUE"===$(initXML.find("plot").find("agg_stat").find("agg_vl1l2")).text()?$("#agg_stat").val("vl1l2"):"mode"===b&&-1!==listStatModelRatio.indexOf(d[0])&&$("#agg_stat").val("mode");try{$("#agg_stat").multiselect("refresh")}catch(r){}$("#boot_repl").val($(initXML.find("plot").find("agg_stat").find("boot_repl")).text());$("#boot_ci").val($(initXML.find("plot").find("agg_stat").find("boot_ci")).text());
$("#cacheAggStat").prop("checked","TRUE"==$(initXML.find("plot").find("agg_stat").find("cache_agg_stat")).text())}else if(0<initXML.find("plot").find("calc_stat").length){$("input[name=statistics][value=calculations_statistics]").prop("checked",!0);$("#calculations_statistics").show();"TRUE"==$(initXML.find("plot").find("calc_stat").find("calc_ctc")).text()?$("#calc_stat").val("ctc"):"TRUE"==$(initXML.find("plot").find("calc_stat").find("calc_sl1l2")).text()?$("#calc_stat").val("sl1l2"):"TRUE"==$(initXML.find("plot").find("calc_stat").find("calc_sal1l2")).text()?
$("#calc_stat").val("sal1l2"):"TRUE"==$(initXML.find("plot").find("calc_stat").find("calc_vl1l2")).text()&&$("#calc_stat").val("vl1l2");try{$("#calc_stat").multiselect("refresh")}catch(r){}}else if("stat"===b)$("input[name=statistics][value=calculations_statistics]").prop("checked",!0),$("#aggregation_statistics ").hide(),$("#none").show();else if(-1!==listStatModelRatio.indexOf(d[0])){$("input[name=statistics][value=aggregation_statistics]").prop("checked",!0);$("#agg_stat").val("mode");try{$("#agg_stat").multiselect("refresh")}catch(r){}$("#aggregation_statistics ").show();
$("#calculations_statistics ").hide()}else $("input[name=statistics][value=calculations_statistics]").prop("checked",!0),$("#aggregation_statistics ").hide(),$("#none").show();a=$(initXML.find("plot").find("tmpl").find("listDiffSeries1")).text();0===a.length&&(a="list()");b=$(initXML.find("plot").find("tmpl").find("listDiffSeries2")).text();0===b.length&&(b="list()");if("list()"!==a)for(e=a.split("c("),a=1;a<e.length;a++)e[a]=e[a].replace(/\(/g,"").replace(/\)/g,"").replace(/"/g,""),seriesDiffY1.push(e[a]);
