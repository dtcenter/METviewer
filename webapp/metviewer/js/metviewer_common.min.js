...
"none")}
function addFixedVarRhist(){var a,b=a=0<fixed_var_indexes.length?parseInt(fixed_var_indexes[fixed_var_indexes.length-1]):1,c="none"===$("#fixed_var_table").css("display"),e,d,f,g;c?(0===fixed_var_indexes.length&&fixed_var_indexes.push(b),$("#fixed_var_table").css("display",""),e=$("#fixed_var_"+b),$("#remove_fixed_var_"+b).button({icons:{primary:"ui-icon-trash"},text:!1}),d=$("#fixed_var_val_"+b),f=$("#fixed_var_val_date_period_button_"+b),g=$("#fixed_var_val_date_period_"+b)):(b=parseInt(a)+1,fixed_var_indexes.push(b),
e=$("#fixed_var_"+a).clone(!1),e.prop("id","fixed_var_"+b),e.css("display",""),e.val(e.find(" option:first").val()));c||(c=$(' <button id="remove_fixed_var_"'+b+'" class="remove_fixed_var">Remove</button>').button({icons:{primary:"ui-icon-trash"},text:!1}).click(function(){removeFixedVarRhist("remove_fixed_var_"+b)}),d=$("#fixed_var_val_"+a).clone(!1),d.prop("id","fixed_var_val_"+b),d.css("display",""),e.val(e.find(" option:first").val()),f=$("<button>",{text:"Select multiple options",id:"fixed_var_val_date_period_button_"+
