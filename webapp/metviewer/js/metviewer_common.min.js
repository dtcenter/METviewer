...
$("#plot_res").val($(initXML.find("plot").find("plot_res")).text()),e=$(initXML.find("plot").find("mar")).text().replace("c(","").replace(")","").split(","),$("#mar_bottom").val(e[0]),$("#mar_left").val(e[1]),$("#mar_top").val(e[2]),$("#mar_right").val(e[3]),e=$(initXML.find("plot").find("mgp")).text().replace("c(","").replace(")","").split(","),$("#mgp_title").val(e[0]),$("#mgp_labels").val(e[1]),$("#mgp_line").val(e[2]),$("#title_align").val($(initXML.find("plot").find("title_align")).text()),$("#title_offset").val($(initXML.find("plot").find("title_offset")).text()),
...
$("#ytlab_horiz").val($(initXML.find("plot").find("ytlab_horiz")).text()),$("#ytlab_perp").val($(initXML.find("plot").find("ytlab_perp")).text()),$("#ytlab_size").val($(initXML.find("plot").find("ytlab_size")).text()),$("#ytlab_orient").val($(initXML.find("plot").find("ytlab_orient")).text()),e=$(initXML.find("plot").find("y1_lim")).text().replace("c(","").replace(")","").split(","),$("#y1_lim_min").val(e[0]),$("#y1_lim_max").val(e[1]),$("#y1_bufr").val($(initXML.find("plot").find("y1_bufr")).text()),
e=$(initXML.find("plot").find("x1_lim")).text().replace("c(","").replace(")","").split(","),$("#x1_lim_min").val(e[0]),$("#x1_lim_max").val(e[1]),$("#y2lab_align").val($(initXML.find("plot").find("y2lab_align")).text()),$("#y2lab_offset").val($(initXML.find("plot").find("y2lab_offset")).text()),$("#y2lab_size").val($(initXML.find("plot").find("y2lab_size")).text()),$("#y2lab_weight").val($(initXML.find("plot").find("y2lab_weight")).text()),$("#y2tlab_horiz").val($(initXML.find("plot").find("y2tlab_horiz")).text()),
$("#y2tlab_perp").val($(initXML.find("plot").find("y2tlab_perp")).text()),$("#y2tlab_size").val($(initXML.find("plot").find("y2tlab_size")).text()),$("#y2tlab_orient").val($(initXML.find("plot").find("y2tlab_orient")).text()),e=$(initXML.find("plot").find("y2_lim")).text().replace("c(","").replace(")","").split(","),$("#y2_lim_min").val(e[0]),$("#y2_lim_max").val(e[1]),$("#y2_bufr").val($(initXML.find("plot").find("y1_bufr")).text()),$("#legend_size").val($(initXML.find("plot").find("legend_size")).text()),
e=$(initXML.find("plot").find("legend_inset")).text().replace("c(","").replace(")","").split(","),$("#legend_inset_min").val(e[0]),$("#legend_inset_max").val(e[1]),$("#legend_box").val($(initXML.find("plot").find("legend_box")).text()),$("#legend_ncol").val($(initXML.find("plot").find("legend_ncol")).text()),$("#caption_align").val($(initXML.find("plot").find("caption_align")).text()),$("#caption_offset").val($(initXML.find("plot").find("caption_offset")).text()),$("#caption_size").val($(initXML.find("plot").find("caption_size")).text()),
$("#caption_weight").val($(initXML.find("plot").find("caption_weight")).text()),e=$(initXML.find("plot").find("caption_col")).text(),7<e.length&&(e=e.substring(0,7)),$("#caption_col").colorpicker("setColor",e)):resetFormatting();$("#release").on("click",function(){var a=window.open("doc/versions.html");a?a.focus():alert("Please allow popups for this site")});d=$("#categories11");for(e=0;e<categories.length;e++){var f=$(categories[e]);c=$('<ul data-label="'+f.attr("name")+'">');f=f.find("db");for(var g=
0;g<f.length;g++){var h=$(f[g]),k=h.find("val"),n=h.find("desc");h=$('<li data-value="'+k.text()+'" title="'+n.text()+'">');k=$('<input name="multiselect_database" type="checkbox" disabled value="'+k.text()+'" title="'+n.text()+'" id="'+k.text()+'" /><label for="'+k.text()+'" >'+k.text()+"</label>lab");h.prepend(k);c.append(h)}d.append(c)}$(".multilevel-dropdown").multilevelDropdown();$("input[name='multiselect_database']").on("change",function(a){if(null!=$(this).val()){var b=[];$("input[name='multiselect_database']:checked").each(function(){b.push($(this).val())});
a=document.createTextNode(1===b.length?b[0]:0===b.length?"Select database":b.length+" selected");var c=document.getElementById("categories1").childNodes[0];c.replaceChild(a,c.childNodes[0]);updatePages()}});$("#header").css("position","static")}
