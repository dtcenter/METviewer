...
function loadImage(id) {
    ...
    var dialog = $('<div>').attr("id", boxID + "dialog").dialog({
        ...
        title: id,
        position: {my: ("center+" + window_center + " top+" + window_top), at: "center top", of: window},
        close: function (e) {
            $(this).empty();
            $(this).dialog('destroy');
            window_center = window_center - 20;
...
function loadXMLSeries() {
    ...
    if (currentTab === 'Perf' || currentTab === 'Taylor') {
        number_of_axis = 1
    } else {
        number_of_axis = 2;
    }
...
//addThemeSwitcher( '#toolbar', { top: '15px' });
    ...
    $("#listdt").jqGrid('navButtonAdd', '#pagerdt', {
        ...
        onClickButton: function () {
            if ( currentTab == 'Roc' || currentTab == 'Rely' || currentTab == 'Ens_ss' || currentTab == 'Perf' || currentTab === "Hist") {
