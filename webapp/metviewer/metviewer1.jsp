...
<HEAD>
  ...
  <TITLE>METviewer 13.0.0-beta3-dev</TITLE>
...
<div id="header" style="overflow: visible; position: static ">
  ...
  <div class="toolbar ui-widget" id="toolbar ">
    <div style="float: left; cursor: alias;font-family: 'Arial Black',Gadget,sans-serif;text-align: left;" >METviewer 13.0.0-beta3-dev
