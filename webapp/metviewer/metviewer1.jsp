...
<HEAD>
  ...
  <TITLE>METviewer 6.2.0-beta1-dev</TITLE>
...
<div id="header" style="overflow: visible; position: static ">
  ...
  <div class="toolbar ui-widget" id="toolbar ">
    <div style="float: left; cursor: alias;font-family: 'Arial Black',Gadget,sans-serif;text-align: left;" >METviewer 6.2.0-beta1-dev
