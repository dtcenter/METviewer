...
<div style="overflow: auto;">
  ...
  <div id="tabs_axis_variables" class="ui-layout-center no-padding" style="border:none;">
    ...
    <div id="y1_axis_variables" class="no-padding">
      <div class="ui-widget-content ui-widget-content-plot ui-corner-all" style=" border-top:none;">
        <div class="ui-widget-header-plot">Y1 Dependent (Forecast) Variables:
          ...
          <tr>
            ...
            <td id="fcst_stat_mode_config_y1_1" style="display: none;">
              <table style="white-space:nowrap;">
                <tr>
                  <td rowspan="2">
                    <input type="checkbox" class="non-acov" name="mode_stat_diff" value="D" onclick="updateSeries();"><label>Diff</label>
                  </td>
                  <td>
                    <input type="checkbox" checked name="mode_stat_fcst" value="F" onclick="updateSeries();"><label>Fcst</label>
                  </td>
                  <td>
                    <input type="checkbox" class="non-acov" checked name="mode_stat_simple" value="S" onclick="updateSeries();"><label>Simple</label>
                  </td>
                  <td>
                    <input type="checkbox" class="non-acov" checked name="mode_stat_matched" value="M" onclick="updateSeries();"><label>Matched</label>
                  </td>
                </tr>
                <tr>
                  <td>
                    <input type="checkbox" checked name="mode_stat_obs" value="O" onclick="updateSeries();"><label>Obs</label>
                  </td>
                  <td>
                    <input type="checkbox" class="non-acov" checked name="mode_stat_cluster" value="C" onclick="updateSeries();"><label>Cluster</label>
                  </td>
                  <td>
                    <input type="checkbox" class="non-acov" checked name="mode_stat_unmatched" value="U" onclick="updateSeries();"><label>Unmatched</label>
                  </td>
                </tr>
              </table>
            </td>
        ...
        <div class="ui-widget-header-plot">Y1 Series Variables:
          <button class="help-button" style="float: right;" alt="series">Help</button>
        </div>
        <table id='series_var_table_y1'>
          <tr>
            ...
            <td>
              <input type="checkbox" id="group_series_var_y1_1" onclick="updateSeries();"><label for="group_series_var_y1_1">Group_y1_1</label>
            </td>
          </tr>
        </table>
    ...
    <div id="y2_axis_variables" class="no-padding">
      <div class="ui-widget-content ui-widget-content-plot ui-corner-all">
        <div class="ui-widget-header-plot">Y2 Dependent (Forecast) Variables:
          <button class="help-button" style="float: right;" alt="dep">Help</button>
        </div>
        ...
        <table id='series_var_table_y2' style="display: none;">
          <tr>
            ...
            <td><input type="checkbox" id="group_series_var_y2_1"
                    ...
                    for="group_series_var_y2_1">Group_y2_1</label></td>
          </tr>
        </table>
  ...
  <div class="ui-widget-content ui-widget-content-plot ui-corner-all">
    ...
    <table id='fixed_var_table' style="display: none;">
      <tr>
        ...
        <td>
          <input type="checkbox" id="fix_var_event_equal_1" title='Add entry to event equalization logic'><label for="fix_var_event_equal_1" title='Add entry to event equalization logic'>Equalize</label>
        </td>
  ...
  <div class="ui-widget-content ui-widget-content-plot ui-corner-all">
    <div class="ui-widget-header-plot">Independent Variable:
      <button class="help-button" style="float: right;" alt="indep">Help</button>
    </div>
    ...
    <table id='indy_var_table'>
      <tr>
        ...
        <td>
          <button id="date_period_button" style="display: none;">Select multiple options</button>
        </td>
        <td>
  ...
  <div id="helpContent" title="Help"></div>
